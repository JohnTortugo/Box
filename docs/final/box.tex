...
aqui mostramos apenas a média arimética destas dez execuções. Durante a execucão
dos testes também foi coletado o número total de instruções e o número de
chamadas ao sistema operacional de cada aplicativo. Essas informações são
apresentadas na Tabela \ref{tab:instr}.
...
\end{table}
 ...
 O Apêndice A contém os valores de intervalo de confiança e desvio padrão, os
 quais omitimos aqui porquê, como pode ser visto no apêndice, a margem de erro e
 o desvio padrão foram despreziveis.
