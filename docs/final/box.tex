...
implementados mecanismos de \emph{prefetch} e pré-decodificação das
instruções. Em sua implementação padrão, a cache possui um total de 64K entradas,
sendo que cada entrada representa a primeira entrada de um bloco de instruções e
o número de instruções contidas no bloco.
...
solicitada já foi decodificada anteriormente, e, em caso afirmativo, o endereço da
