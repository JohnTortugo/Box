...
instrução. Em sua implementação padrão, a cache possui um total de 64K entradas,
...
solicitada já foi decodificada anteriormente, em caso afirmativo. O endereço da
