...
Ainda segundo os autores, a ABI possui dois componentes básicos: as instruções pertencentes ao user-ISA; e uma interface para comunicação com o sistema operacional, a qual garante acesso aos recursos do sistema.
