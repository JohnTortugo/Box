...
\begin{itemize}
 ...
 \item Aplicação sistemáticas de teste e medição e análise de desempenho em ambiente real, no ambiente virtualizado de sistema (\emph{Bochs}) e no ambiente proposto (\emph{Box});
...
O sistema proposto utilizará o Bochs como ponto de partida para desenvolvimento. 
...
Tais subsistemas são desnecessários em uma máquina virtual de processos, visto que são abstraídos pelo sistema operacional e por esse motivo serão removidos do projeto.
